                    ...
                    <div className="card h-100">
                        <div className="card-body h-100 p-5">
                            <div className="row align-items-center">
                                ...
                                <div className="col-xl-4 col-xxl-12 text-center"><img className="img-fluid" src="assets/img/illustrations/at-work.svg" style="max-width: 26rem" /></div>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="dropdown no-caret">
                                ...
                                <div className="dropdown-menu dropdown-menu-end animated--fade-in-up" aria-labelledby="dropdownMenuButton">
                                    <a className="dropdown-item" href="#!">
                                        <div className="dropdown-item-icon"><i className="text-gray-500" data-feather="list"></i></div>
                                        Manage Tasks
                                    </a>
                                    <a className="dropdown-item" href="#!">
                                        <div className="dropdown-item-icon"><i className="text-gray-500" data-feather="plus-circle"></i></div>
                                        Add New Task
                                    </a>
                                    <a className="dropdown-item" href="#!">
                                        <div className="dropdown-item-icon"><i className="text-gray-500" data-feather="minus-circle"></i></div>
                                        Delete Tasks
                                    </a>
                                </div>
                            </div>
                ...
                <div className="col-xl-6 mb-4">
                    <div className="card card-header-actions h-100">
                        <div className="card-header">
                            Earnings Breakdown
                            <div className="dropdown no-caret">
                                <button className="btn btn-transparent-dark btn-icon dropdown-toggle" id="areaChartDropdownExample" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i className="text-gray-500" data-feather="more-vertical"></i></button>
                    ...
                    <table id="datatablesSimple">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <button className="btn btn-datatable btn-icon btn-transparent-dark me-2"><i className="fa-solid fa-ellipsis-vertical"></i></button>
                                    <button className="btn btn-datatable btn-icon btn-transparent-dark"><i className="fa-regular fa-trash-can"></i></button>
                                </td>
                            </tr>
                            <tr>
